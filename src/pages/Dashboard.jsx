          ...
          <header className="mb-8 sm:mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-3 max-w-full lg:max-w-4xl cursor-pointer my-6">
              ...
              {remainingBalance > 10000 ? (
                ...
                <div className="flex flex-col py-5 pl-4 pr-8 sm:pr-16 bg-gradient-to-r from-red-500 to-red-400 rounded-lg">
                  <div className="flex items-center gap-1.5 text-red-100) mb-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
